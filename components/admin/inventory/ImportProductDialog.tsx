...
export default function ImportProductDialog({ open, onOpenChange, onSuccess }: ImportProductDialogProps) {
    ...
    const handleDownloadTemplate = () => {
        const headers = ["name", "sku", "category", "price", "price_cost", "price_sale", "initialStock", "description", "long_description", "weight_g", "variations", "specifications", "features", "whats_included"];
